const english = {
  ...
  featureDescription: "A variety of locally-developed technical products that are tailored to your needs, so you don't have to waste time searching.",
  viewmore: "Read more",
  featureTitleEktefa: "Ektefa",
  featurecardDescriptionEktefa: "An HR SaaS solution that empowers your employees in the digital age.",
  featureTitleNafeth: "Nafeth",
  featurecardDescriptionNafeth: "A SaaS system that gives car rental companies the tools they need to manage their business and handle daily tasks with ease and efficiency.",
  featureTitleMuaref: "Muaref",
  featurecardDescriptionMuaref: "A revolutionary technology that replaces biometrics with QR codes and location services to make attendance management more secure, efficient, and user-friendly.",
  featureTitleEhtiwa: "Attendance solutions",
  featurecardDescriptionEhtiwa: "With Ehtwa, you can reach over 65,000 employees with your offers in just a few clicks.",
  featureTitlecadre: "Reliable jobs",
  featurecardDescriptionCadre: "CADRE app is the first solution that links job seekers with more than 400 companies, providing them with a unique opportunity to find their dream job.",
  ...
  valueAddesDescription: "ZADIP GROUP is committed to supporting the Kingdom's Vision 2030. Everything we build or develop aligns with the aspirations of this ambitious plan to transform the Kingdom's economy. We strive to provide services that meet the standards of Vision 2030, and we help local establishments comply with these standards.<br></br>We believe that Vision 2030 is the key to the Kingdom's future prosperity. We are proud to be a part of this journey, and we are committed to doing our part to make Vision 2030 a success.",
  ...
  conditions: "This type of subscription is a point-based system and good for those small businesses that don’t use a lot of operations per year. You will pay listed above subscription fees plus you need to charge your account.",
  ...
  projects_it: "IT project management services",
  professionalServices: "We are your one-stop shop for IT project management, from hardware and software procurement to configuration and installation",
