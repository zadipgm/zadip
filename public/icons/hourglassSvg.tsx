const HourGlassSvg = ({
  ...
  return (
    ...
    >
      <path
        d="M25.591,4.091c0-3.02-4.85-4.091-9-4.091c-4.151,0-9,1.071-9,4.091c0,3.467,4.048,9.963,6.531,12.5
      ...
      />
      <path
        d="M10.527,29.957c0,0.186,2.085,0.725,6.064,0.725c3.979,0,6.064-0.539,6.064-0.725c0-2.752-6.064-4.647-6.064-9.575
			C16.591,25.31,10.527,27.102,10.527,29.957z"
      />
      <path
        d="M16.474,15.352l0.117,1.066l0.117-1.066c1.188-0.67,5.275-5.955,5.275-8.221c0-0.299-1.854-1.165-5.394-1.165
